...
class OnboardingTask: ORKNavigableOrderedTask {
    ...
    let declineText = "Unfortunately you cannot use the product if you don’t complete or agree to the informed consent. No data has been collected from you so far from your or your device. If you wish to participate, then please complete the consent process.\n\nIf you have any questions or concerns about the study you can email us at support@painoa.org"
